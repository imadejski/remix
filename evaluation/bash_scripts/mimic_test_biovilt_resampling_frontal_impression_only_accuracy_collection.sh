...
output_base_path="/opt/gpudata/imadejski/search-model/ctds-search-model/data/mimic_test/frontal_impression_only"
split_type="test"
...
for model in "${model_configs[@]}"; do
    ...
    if [ ! -f "$output_path/model_top_n_accuracy_results.csv" ]; then
